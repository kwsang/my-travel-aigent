...
- **Immediate Save**: You MUST invoke `save_itinerary` to store the newly added ACCOMMODATION and transit (FLIGHT/TRANSPORT) events IMMEDIATELY. Do not wait for the end of the conversation to save.
