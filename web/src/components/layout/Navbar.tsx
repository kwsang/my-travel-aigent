...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-white/80 backdrop-blur-md border-b border-slate-200 shrink-0 z-[100] sticky top-0">
        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="font-bold text-xl text-slate-900 tracking-tight">Travel AIgent</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/dashboard" className="bg-indigo-600 text-white px-5 py-2 rounded-xl text-sm font-bold shadow-md hover:bg-indigo-700 transition-all hover:scale-105 active:scale-95">
              Launch App
            </Link>
          </div>
